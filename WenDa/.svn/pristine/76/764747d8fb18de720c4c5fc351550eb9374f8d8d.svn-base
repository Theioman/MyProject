...
<div class="dvhead">
	...
	<div class="dvreg">
		${sessionScope.user==null?"已有账号，立即&nbsp;<a href='login.jsp'>登录</a>":sessionScope.username }
	</div>
</div>
...
<div class="main layui-clear">
  <div class="fly-panel" pad20>
    ...
    <div class="layui-form layui-form-pane">
      <form action="<%=request.getContextPath() %>/QuestionServlet?operator=sendQuestion" method="post">
