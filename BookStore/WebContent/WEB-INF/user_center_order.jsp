						...
						<tr>
							<td width="55%">
								...
								<ul class="order_book_list clearfix">					
									...
									<li class="col04"><fmt:formatNumber type="number" value="${od.bnum*od.book.bprice}" maxFractionDigits="2"></fmt:formatNumber>元</li>	
								</ul>
								</c:forEach>
							</td>
							<td width="15%"><fmt:formatNumber type="number" value="${o.totalprice}" maxFractionDigits="2"></fmt:formatNumber>元</td>
