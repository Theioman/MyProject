...
<body>
	...
	<div class="main_con clearfix">
		...
		<div class="right_content clearfix">
				...
				<li>
					<a href="<%=request.getContextPath()%>/bookDetail.do?id=${r.book.id}"><img src="${r.book.imgpath}"></a>
					<h4><a href="<%=request.getContextPath()%>/bookDetail.do?id=${r.book.id}">${r.book.bname}</a></h4>
					<div class="operate">
