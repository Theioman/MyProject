...
<body>
	...
	<div class="search_bar clearfix">
		...
		<div class="search_con fr">
			<input type="text" class="input_text fl" name="bname" id="condition" placeholder="搜索商品">
			...
			<ul class="cart_list_td clearfix" id="${ca.cdid}">
				...
				<li class="col06">
					<div class="num_add">
						...
						<input name="bnum" type="text" class="num_show fl" value="${ca.bnum}" id="inp${ca.cdid}" onblur="updateTest(${ca.cdid})">	
