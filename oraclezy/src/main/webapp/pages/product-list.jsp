                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="编辑" onclick="location.href='${pageContext.request.contextPath}/pages/product-update.jsp'"><i
                            ...
                            <c:forEach items="${list}" var="product">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/delete?id=${product.id}'">删除</button>
